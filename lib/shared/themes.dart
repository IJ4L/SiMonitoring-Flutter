...
const Color kPrimaryColor = Color(0xff2A55C9);
const Color kSecondColor = Color(0xffFF8B1F);
const Color kTextInfoColor = Color(0xff47464A);
...
TextStyle greenTextStyle = const TextStyle(color: kGreenColor);
